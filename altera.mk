...
#------------------------------------------------------------------------------
.PHONY: all load_dev build_prj create_prj clean clean_all print-% test

all:    build_prj

load_dev: $(TARGET_FILE_NAME).cdf $(TRG_FILE)
	$(SHELL_DIR)/$(PGM_SHELL) --cable $(DEV) $(TARGET_FILE_NAME).cdf
